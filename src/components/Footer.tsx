                ...
                <div className='w-full h-full'>
                    <div className='md:flex md:justify-between'>
                        <div className='mb-6 md:mb-0'>
                            ...
                            <p className="my-6 font-normal">The world’s first and largest digital marketplace for crypto collectibles and non-fungible tokens (NFTs). Buy, sell, and discover exclusive digital items.</p>
                        </div>
